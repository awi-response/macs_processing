...
logging.basicConfig(#filename=settings.PROJECT_DIR / f'{settings.PROJECT_DIR.name}.log', 
                    level=logging.INFO, 
...
def main():
    ...
    settings.TARGET_DIR_ORTHO = tiles_dir = PRODUCT_DIR / 'Ortho'
    settings.TARGET_DIR_DSM = tiles_dir = PRODUCT_DIR / 'DSM'
